<?php return [
    ...
    'common' => [
        ...
        'shipping_providers' => 'Prestataires de livraison',
    ...
    'shipping_provider' => [
        'label' => 'Founisseur de livraison',
        'default' => 'Classique',
    ],
    'shipping_provider_settings' => [
        'description' => 'Configurez vos prestataires de livraison',
    ],
    'payment_status' => [
        'paid' => 'Payé',
        'deferred' => 'Différé',
    ...
    'permissions' => [
        'manage_products' => 'Peut gérer les produits',
        'manage_categories' => 'Peut gérer les categories',
        'manage_orders' => 'Peut gérer les orders',
        'manage_discounts' => 'Peut gérer les discounts',
        'settings' => [
        ...
        'manage_customer_groups' => 'Peut gérer les customer groups',
        'manage_customer_addresses' => 'Peut gérer les customer addresses',
        'manage_notifications' => 'Peut gérer les notifications',
        'manage_price_categories' => 'Peut gérer les price categories',
        'manage_order_states' => 'Peut gérer les order states',
        'manage_shipping_methods' => 'Peut gérer les méthodes de livraison',
        'manage_shipping_providers' => 'Peut gérer les fournisseurs de livraions',
        'manage_taxes' => 'Peut gérer les taxes',
        'manage_payment_log' => 'Peut gérer les payment log',
